defmodule PhxCheckgroupWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: PhxCheckgroupWeb.Gettext
  ...
  # https://gist.github.com/brainlid/9dcf78386e68ca03d279ae4a9c8c2373
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxCheckgroupWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxCheckgroupWeb.Gettext, "errors", msg, opts)
    end
  end
